...
urlpatterns = [
    ...
    path('reports/chart-of-accounts/', views.report_chart_of_accounts, name='report_chart_of_accounts'),
    ...
    path('taxes/withholding/', views.report_withholding_tax, name='report_withholding_tax'),
    path('taxes/liabilities/', views.report_tax_liabilities, name='report_tax_liabilities'),
]